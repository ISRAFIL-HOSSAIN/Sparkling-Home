...
export default async function Footer({ lang }: { lang: Locale }) {
  ...
  return (
    <footer className='bg-secondprimary px-16 py-12 font-[sans-serif]'>
      <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4'>
        ...
        <div className='flex items-center lg:justify-center'>
          <a href='javascript:void(0)'>
            <h2 className='lg:text-[26px] text-[20px] text-white font-bold'>Glansan<span className='text-primary font-bold '>dehem</span></h2>{' '}
          </a>
          {/* <a href='javascript:void(0)'><img src="https://readymadeui.com/readymadeui-light.svg" alt="logo" className='w-60' /></a> */}
        </div>
      </div>
