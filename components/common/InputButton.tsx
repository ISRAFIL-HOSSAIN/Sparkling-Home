...
const InputButton = ({
  ...
  const handleSubmit = () => {
    if(!size && !postCode){
      setError("To calculate the price, we need to know the size of your home and your postcode. ")
      return
    }
    if (!isValid(postCode)) {
  ...
  return (
    <div className='flex flex-col justify-center items-center '>
      <div className={` ${error && "shadow-lg shadow-red-400"}  bg-white   rounded-full flex flex-row justify-center items-center mt-10 lg:w-[588px] md:w-[500px] w-[85%] lg:mx-0 `}>
